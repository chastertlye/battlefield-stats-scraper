...
def main():
    ...
    parser.add_argument(
        ...
        required=True,
        type=str,
        help=f"Path to the output CSV file for player statistics.",
    )
    parser.add_argument(
        "-g",
        "--game",
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help=f"Delay in seconds between scraping cycles. (default: 0s)",
    )
    parser.add_argument(
        "-b",
        "--batch",
        type=int,
        default=1,
        help=f"Number of players per batch to write to the dataset. (default: 1)",
    )
    parser.add_argument(
        "-inf",
        "--infinite",
        action="store_true",
        help=f"Run scraper in endless mode.",
    )
